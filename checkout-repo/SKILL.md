...
Read these if present (skip silently if absent): `README.md`, `docs/`, `.gitignore`, `things_to_know`. These give purpose and any project-specific working rules, follow those rules for the rest of the session.
